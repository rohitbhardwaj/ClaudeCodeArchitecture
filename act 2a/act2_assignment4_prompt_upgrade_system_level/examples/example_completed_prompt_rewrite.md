# Example Completed Prompt Rewrite
...
## Pair Discussion Answer

What changed?

```text
The new prompt stopped treating CheckoutService.java as the whole problem.
It turned the task into a system investigation.
It added tests, API contract, security, rollback, and approval constraints.
```
