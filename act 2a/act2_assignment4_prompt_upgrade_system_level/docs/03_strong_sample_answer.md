...
Use this as the reference answer.
...
```text
local fixes that break API behavior
coupon logic changes without approval
test weakening
security-sensitive logging mistakes
pricing/tax/payment side effects
unreviewable multi-file changes
```
